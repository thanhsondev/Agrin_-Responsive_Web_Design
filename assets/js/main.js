...
brandButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        // Show the product list for the selected brand
        const selectedProductList = document.getElementById(`${selectedBrand}-products`);
...
document.getElementById('show-all-button').addEventListener('click', function() {
    ...
    // Loop through product lists and make them visible
